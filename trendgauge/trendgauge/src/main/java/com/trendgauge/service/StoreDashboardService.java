...
public class StoreDashboardService {
    ...
    public StoreDashboardService(SaleRepository saleRepository, StoreRepository storeRepository, TargetRepository targetRepository){
    ...
    public List<StoreRankingResponse> getRanking(){
